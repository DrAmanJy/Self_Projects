    ...
    for (const K of j)
      if (K.type === "childList")
        for (const nl of K.addedNodes)
          nl.tagName === "LINK" && nl.rel === "modulepreload" && r(nl);
...
function D1() {
  ...
  function $(r, j, K) {
    ...
    if (
      ...
      K = {};
      for (var gl in j) gl !== "key" && (K[gl] = j[gl]);
    } else K = j;
    return (
      (j = K.ref),
      { $$typeof: M, type: r, key: nl, ref: j !== void 0 ? j : null, props: K }
    );
  }
  return (re.Fragment = vl), (re.jsx = $), (re.jsxs = $), re;
}
var kv;
function U1() {
...
function R1() {
  ...
  function Ll(s, A, D, z, H, w) {
    return (
      (D = w.ref),
      { $$typeof: M, type: s, key: A, ref: D !== void 0 ? D : null, props: w }
    );
  }
  function Kl(s, A) {
  ...
  function Nl(s, A, D, z, H) {
        ...
        case "object":
          switch (s.$$typeof) {
            ...
            case vl:
              ...
              break;
            case O:
              return (x = s._init), Nl(x(s._payload), A, D, z, H);
          }
      }
    if (x)
      return (
    ...
    if (dt(s))
      for (var il = 0; il < s.length; il++)
        (z = s[il]), (w = Jl + Rl(z, il)), (x += Nl(z, A, D, w, H));
    else if (((il = fl(s)), typeof il == "function"))
      for (s = il.call(s), il = 0; !(z = s.next()).done; )
        (z = z.value), (w = Jl + Rl(z, il++)), (x += Nl(z, A, D, w, H));
    else if (w === "object") {
      if (typeof s.then == "function") return Nl(hu(s), A, D, z, H);
      throw (
        ((A = String(s)),
        Error(
  ...
  return (
    ...
    (G.StrictMode = r),
    (G.Suspense = N),
    (G.__CLIENT_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE = J),
    ...
    (G.createElement = function (s, A, D) {
      var z,
        H = {},
        w = null;
      if (A != null)
    ...
    (G.isValidElement = rt),
    (G.lazy = function (s) {
      return { $$typeof: O, _payload: { _status: -1, _result: s }, _init: _ };
    }),
    (G.memo = function (s, A) {
    ...
    (G.useActionState = function (s, A, D) {
      return J.H.useActionState(s, A, D);
    }),
    ...
    (G.useImperativeHandle = function (s, A, D) {
      return J.H.useImperativeHandle(s, A, D);
    }),
    ...
    (G.useReducer = function (s, A, D) {
      return J.H.useReducer(s, A, D);
    }),
    (G.useRef = function (s) {
      return J.H.useRef(s);
    }),
    ...
    (G.useSyncExternalStore = function (s, A, D) {
      return J.H.useSyncExternalStore(s, A, D);
    }),
  ...
  return (
    Pv ||
      ...
      (function (M) {
            ...
            l: for (var al = 0, s = g.length, A = s >>> 1; al < A; ) {
              ...
              if (0 > j(z, Y))
                H < s && 0 > j(w, z)
                  ? ((g[al] = w), (g[H] = Y), (al = H))
                  : ((g[al] = z), (g[D] = Y), (al = D));
              else if (H < s && 0 > j(w, Y)) (g[al] = w), (g[H] = Y), (al = H);
              else break l;
            }
          }
          return _;
        ...
        function dt(g) {
          for (var _ = $(E); _ !== null; ) {
            if (_.callback === null) r(E);
              ...
              r(E), (_.sortIndex = _.expirationTime), vl(N, _);
            else break;
            _ = $(E);
          }
        }
        function J(g) {
          if (((yt = !1), dt(g), !Bl))
            if ($(N) !== null) (Bl = !0), Vl || ((Vl = !0), Rl());
            else {
              var _ = $(E);
              _ !== null && Nl(J, _.startTime - g);
            }
        }
        var Vl = !1,
          Ll = -1,
              ...
              l: {
                ...
                try {
                  t: {
                    for (
                      dt(g), Z = $(N);
                      Z !== null && !(Z.expirationTime > g && qu());

                    ) {
                      var al = Z.callback;
                      if (typeof al == "function") {
                        (Z.callback = null), (fl = Z.priorityLevel);
                        var s = al(Z.expirationTime <= g);
                        if (((g = M.unstable_now()), typeof s == "function")) {
                          (Z.callback = s), dt(g), (_ = !0);
                          break t;
                        }
                        Z === $(N) && r(N), dt(g);
                      } else r(N);
  ...
  return (
    ...
    (pl.flushSync = function (N) {
      var E = nl.T,
        O = r.p;
      try {
        if (((nl.T = null), (r.p = 2), N)) return N();
      } finally {
        (nl.T = E), (r.p = O), r.d.f();
      }
    }),
    (pl.preconnect = function (N, E) {
      typeof N == "string" &&
        (E
          ? ((E = E.crossOrigin),
            (E =
    ...
    (pl.preinit = function (N, E) {
      if (typeof N == "string" && E && typeof E.as == "string") {
        var O = E.as,
          Z = gl(O, E.crossOrigin),
    ...
    (pl.preinitModule = function (N, E) {
      if (typeof N == "string")
        if (typeof E == "object" && E !== null) {
          if (E.as == null || E.as === "script") {
            var O = gl(E.as, E.crossOrigin);
            r.d.M(N, {
              crossOrigin: O,
    ...
    (pl.unstable_batchedUpdates = function (N, E) {
      return N(E);
    }),
    (pl.useFormState = function (N, E, O) {
      return nl.H.useFormState(N, E, O);
    }),
...
function Y1() {
  ...
  function ge(l) {
    w.current === l && (D(H), D(w)),
      Jl.current === l && (D(Jl), (ye._currentValue = Y));
  }
  ...
  var Ct = Math.random().toString(36).slice(2),
    ...
    Aa = "__reactMarker$" + Ct;
  function Cn(l) {
    delete l[Hl], delete l[Xl], delete l[Zn], delete l[Sy], delete l[gy];
  }
  function Yu(l) {
    var t = l[Hl];
    if (t) return t;
...
` +
  ...
  var ru = {
    ...
    Ri = jl(qe),
    Uy = O({}, qe, { dataTransfer: 0 }),
    Ry = jl(Uy),
    Ny = O({}, Ma, { relatedTarget: 0 }),
    uf = jl(Ny),
    Hy = O({}, ru, { animationName: 0, elapsedTime: 0, pseudoElement: 0 }),
    qy = jl(Hy),
    py = O({}, ru, {
  ...
  var Qy = O({}, Ma, {
    ...
    Ly = jl(Vy),
    Ky = O({}, ru, { propertyName: 0, elapsedTime: 0, pseudoElement: 0 }),
    Jy = jl(Ky),
    wy = O({}, qe, {
      deltaX: function (l) {
        return "deltaX" in l
  ...
  function bf(l) {
    for (; l === Xe; )
      (Xe = $u[--ku]), ($u[ku] = null), (je = $u[--ku]), ($u[ku] = null);
    for (; l === Tu; )
      (Tu = ft[--ct]),
        (ft[ct] = null),
        (Rt = ft[--ct]),
  ...
  function pa(l) {
    ...
    if (
      ...
      t === 27
        ? ((t = dl), nu(l.type) ? ((l = Qc), (Qc = null), (dl = l)) : (dl = t))
  ...
  function Ht(l) {
    (l._currentValue = Ef.current), D(Ef);
  }
  function Af(l, t, u) {
    for (; l !== null; ) {
      var a = l.alternate;
  ...
  var Pu = A(null),
    Ke = A(0);
  function bs(l, t) {
    (l = Xt), z(Ke, l), z(Pu, t), (Xt = l | t.baseLanes);
  }
  function qf() {
    z(Ke, Xt), z(Pu, Pu.current);
  }
  function pf() {
    (Xt = Ke.current), D(Pu), D(Ke);
  }
  var Wt = 0,
    X = null,
    ll = null,
  ...
  function Ts(l) {
    ...
    if (((Wt = 0), (rl = ll = X = null), (Je = !1), (La = 0), (ta = null), t))
      throw Error(r(300));
    l === null ||
      Al ||
  ...
  function bd() {
    ...
    return (
      ...
      (l = l.useState()[0]),
      (ll !== null ? ll.memoizedState : null) !== l && (X.flags |= 1024),
      t
    );
  }
  function xf() {
  ...
  function Xf(l) {
    ...
    (Wt = 0), (rl = ll = X = null), (la = !1), (La = we = 0), (ta = null);
  }
  function Ql() {
    var l = {
      memoizedState: null,
  ...
  function Zf(l, t, u) {
    ...
    if (((n = l.baseState), e === null)) l.memoizedState = n;
      ...
      if (
        (i === null ? (f = n) : (i.next = c),
        !$l(n, l.memoizedState) && ((Al = !0), S && ((u = Iu), u !== null)))
      )
        throw u;
      (l.memoizedState = n),
        (l.baseState = f),
  ...
  function zs(l, t, u) {
    (l.flags |= 16384),
      ...
      (t = X.updateQueue),
      t === null
        ? ((t = jf()), (X.updateQueue = t), (t.stores = [l]))
  ...
  function xs(l, t, u) {
    ...
    return (
      u !== t.memoizedState &&
        ((X.flags |= 2048), ua(9, ke(), Ed.bind(null, e, u), null)),
      [a, n, l]
    );
  }
  function Ed(l, t) {
  ...
  function Jf(l, t, u) {
    return u === void 0 || (Wt & 1073741824) !== 0
      ? (l.memoizedState = t)
      : ((l.memoizedState = u), (l = $0()), (X.lanes |= l), (tu |= l), u);
  }
  function ws(l, t, u, a) {
    return $l(u, t)
      ? u
  ...
  var Pe = {
    ...
    u0 = {
      ...
      useCacheRefresh: function () {
        return (Ql().memoizedState = zd.bind(null, X));
      },
    },
    a0 = {
      readContext: ql,
  ...
  function n0(l) {
    ...
    function S(y, v, d, b, U) {
      return v === null || v.tag !== 7
        ? ((v = bu(d, y.mode, b, U)), (v.return = y), v)
        : ((v = e(v, d)), (v.return = y), v);
    }
    function T(y, v, d) {
      if (
    ...
    function o(y, v, d, b) {
      ...
      if (
        ...
        return U !== null ? null : c(y, v, "" + d, b);
      if (typeof d == "object" && d !== null) {
        switch (d.$$typeof) {
          case fl:
            return d.key === U ? i(y, v, d, b) : null;
          case Yl:
            return d.key === U ? h(y, v, d, b) : null;
          case Kl:
            return (U = d._init), (d = U(d._payload)), o(y, v, d, b);
        }
        if (Nl(d) || Rl(d)) return U !== null ? null : S(y, v, d, b, null);
    ...
    function m(y, v, d, b, U) {
      if (
        (typeof b == "string" && b !== "") ||
        typeof b == "number" ||
        typeof b == "bigint"
      )
        return (y = y.get(d) || null), c(v, y, "" + b, U);
      if (typeof b == "object" && b !== null) {
        switch (b.$$typeof) {
          case fl:
            return (
              (y = y.get(b.key === null ? d : b.key) || null), i(v, y, b, U)
            );
          case Yl:
            return (
              (y = y.get(b.key === null ? d : b.key) || null), h(v, y, b, U)
            );
          case Kl:
            var Q = b._init;
            return (b = Q(b._payload)), m(y, v, d, b, U);
        }
        if (Nl(b) || Rl(b)) return (y = y.get(d) || null), S(v, y, b, U, null);
        if (typeof b.then == "function") return m(y, v, d, ln(b), U);
        if (b.$$typeof === Ul) return m(y, v, d, Ze(v, b), U);
        tn(v, b);
      }
      return null;
    }
    function B(y, v, d, b) {
      for (
        var U = null, Q = null, R = v, p = (v = 0), _l = null;
        R !== null && p < d.length;
        p++
      ) {
        ...
        l && R && W.alternate === null && t(y, R),
          (v = n(W, v, p)),
          Q === null ? (U = W) : (Q.sibling = W),
          (Q = W),
          (R = _l);
      }
      if (p === d.length) return u(y, R), k && Eu(y, p), U;
      if (R === null) {
        for (; p < d.length; p++)
          (R = T(y, d[p], b)),
            R !== null &&
              ((v = n(R, v, p)),
              Q === null ? (U = R) : (Q.sibling = R),
              (Q = R));
        return k && Eu(y, p), U;
      }
    ...
    function q(y, v, d, b) {
      ...
      for (
        var U = null, Q = null, R = v, p = (v = 0), _l = null, W = d.next();
        R !== null && !W.done;
        p++, W = d.next()
      ) {
        R.index > p ? ((_l = R), (R = null)) : (_l = R.sibling);
        ...
        l && R && vu.alternate === null && t(y, R),
          (v = n(vu, v, p)),
          Q === null ? (U = vu) : (Q.sibling = vu),
          (Q = vu),
          (R = _l);
      }
      if (W.done) return u(y, R), k && Eu(y, p), U;
      if (R === null) {
      ...
      if (
        ...
        switch (d.$$typeof) {
          ...
          case Yl:
            ...
            return f(y);
          case Kl:
            return (U = d._init), (d = U(d._payload)), ul(y, v, d, b);
        }
        if (Nl(d)) return B(y, v, d, b);
        if (Rl(d)) {
          if (((U = Rl(d)), typeof U != "function")) throw Error(r(150));
          return (d = U.call(d)), q(y, v, d, b);
        }
        if (typeof d.then == "function") return ul(y, v, ln(d), b);
        if (d.$$typeof === Ul) return ul(y, v, Ze(y, d), b);
        tn(y, d);
      }
  ...
  function S0(l, t, u, a, e) {
    ...
    return (
      ...
      l !== null && !Al
        ? (Gf(l, t, e), Yt(l, t, e))
        : (k && c && gf(t), (t.flags |= 1), Ol(l, t, a, e), t.child)
    );
  }
  ...
  function Pf(l, t, u, a, e) {
    return (
      ...
      l !== null && !Al
        ? (Gf(l, t, e), Yt(l, t, e))
        : (k && a && gf(t), (t.flags |= 1), Ol(l, t, u, e), t.child)
    );
  }
  function A0(l, t, u, a, e, n) {
    return (
      ...
      l !== null && !Al
        ? (Gf(l, t, n), Yt(l, t, n))
        : (k && a && gf(t), (t.flags |= 1), Ol(l, t, u, n), t.child)
    );
  }
        ...
        l: {
          ...
          if (
            ...
            if (
              ...
              (e = et(Error(r(424)), t)), Ba(e), (t = _0(l, t, a, u));
              break l;
            } else {
      ...
      case 27:
        return (
          ...
          l === null &&
            ...
            (gt = !0),
            (e = dl),
            nu(t.type) ? ((Qc = e), (dl = mt(a.firstChild))) : (dl = e)),
  ...
  function Ud(l, t, u) {
    ...
    switch ((bf(t), t.tag)) {
      ...
      case 19:
        if ((D(Tl), (e = t.memoizedState), e === null)) return yl(t), null;
  ...
  function $0() {
    st === 0 && (st = (L & 536870912) === 0 || k ? fi() : 536870912);
    var l = it.current;
  ...
  function tt(l, t, u) {
    ((l === cl && (I === 2 || I === 9)) || l.cancelPendingCommit !== null) &&
      ...
      Ea(l, u),
      ((F & 2) === 0 || l !== cl) &&
        (l === cl && ((F & 2) === 0 && (Nu |= u), hl === 4 && eu(l, L, st, !1)),
        At(l));
  }
  function k0(l, t, u) {
  ...
  function F0(l, t, u, a, e, n, f, c, i, h, S, T, o, m) {
    if (
      ((l.timeoutHandle = -1),
      (T = t.subtreeFlags),
      ...
      t === ja || t === Ve
        ...
        : (I =
            t === r0
              ...
              : 1),
      (Pl = t),
      C === null && ((hl = 1), en(l, et(t, l.current)));
  }
  function P0() {
    var l = g.H;
        ...
        if (I !== 0 && C !== null) {
          ...
          switch (I) {
            ...
            case 6:
              it.current === null && (t = !0);
              var h = I;
              if (((I = 0), (Pl = null), da(l, c, i, h), u && ca)) {
                f = 0;
                break l;
              }
              break;
            default:
              (h = I), (I = 0), (Pl = null), da(l, c, i, h);
          }
        }
        Bd(), (f = hl);
        break;
        ...
        if (I !== 0 && C !== null) {
          ...
          t: switch (I) {
            ...
            case 5:
              ...
              (I = 0), (Pl = null), da(l, t, n, 5);
              break;
            case 6:
              (I = 0), (Pl = null), da(l, t, n, 6);
              break;
            case 8:
              Ec(), (hl = 6);
              break l;
  ...
  function da(l, t, u, a) {
    ...
    try {
      if (Md(l, e, t, u, L)) {
        (hl = 1), en(l, et(u, l.current)), (C = null);
        return;
      }
    } catch (n) {
  ...
  function Xd(l, t, u) {
    ...
    a !== null && a.delete(t),
      ...
      cl === l &&
        (L & u) === u &&
        (hl === 4 || (hl === 3 && (L & 62914560) === L && 300 > St() - Sc)
          ? (F & 2) === 0 && ya(l, 0)
          : (mc |= u),
        ia === L && (ia = 0)),
      At(l);
    ...
    if (a && l) {
      ...
      if (!f) {
        ...
        if ((f = a.querySelector(ie(n)))) c.loading = 5;
          ...
          (l = O({ rel: "stylesheet", href: l, "data-precedence": t }, u)),
            (u = vt.get(n)) && Zc(l, u);
    ...
    (qn.prototype.unmount = $c.prototype.unmount =
      function () {
        ...
        if (l !== null) {
          ...
          Qv(l.current, 2, null, l, null, null), hn(), (t[pu] = null);
        }
      });
  function qn(l) {
    this._internalRoot = l;
...
function G1(M) {
  return P.jsx("footer", {
    children: P.jsx("div", {
      ...
      children: "© 2025 CryptoTracker by Aman Lathar",
    }),
  });
}
function X1() {
  return P.jsx("header", {
    children: P.jsxs("nav", {
      className: "flex justify-between p-5 text-2xl bg-black text-white",
      children: [
        P.jsx("div", { className: "logo", children: "CryptoTracker" }),
        P.jsx("div", { children: "@DrAmanJy" }),
      ],
    }),
  });
}
function j1() {
  const [M, vl] = ga.useState(""),
    [$, r] = ga.useState([]),
    [j, K] = ga.useState(""),
    [nl, gl] = ga.useState(null);
  ga.useEffect(() => {
    fetch(
  ...
  function N() {
    ...
    const O = $.filter(
      (Z) =>
        Z.name.toLowerCase().includes(M.toLowerCase()) ||
        Z.symbol.toLowerCase().includes(M.toLowerCase())
    );
    gl(O);
  }
  function E(O) {
    return !O || O.length === 0
      ...
      : O.map((Z) =>
          P.jsxs(
            ...
            {
              className:
                "flex w-[500px] gap-7 p-3 bg-black text-white rounded-2xl justify-center items-center overflow-hidden",
              children: [
                P.jsx("img", {
                  className: "w-1/2",
                  src: Z.image,
                ...
                P.jsxs("div", {
                  ...
                  children: [
                    P.jsxs("div", {
                      children: [Z.name, " ", `[${Z.symbol.toUpperCase()}]`],
                    }),
                    P.jsxs("div", { children: ["$", Z.current_price] }),
                    P.jsx("div", {
                      className:
                        Z.price_change_24h > 0
                          ? "text-green-500"
                          : "text-red-500",
                      children: Z.price_change_24h.toFixed(2),
                    }),
                  ],
                }),
              ],
    ...
    children: [
      ...
      P.jsxs("main", {
        ...
        children: [
          ...
          P.jsxs("div", {
            ...
            children: [
              P.jsx("input", {
                ...
                value: M,
                onChange: (O) => {
                  vl(O.currentTarget.value),
                    O.currentTarget.value.trim() === "" && gl(null);
                },
                className: "border rounded m-4 p-2 w-52",
                placeholder: "Search by name or symbol",
              }),
              P.jsx("button", {
                onClick: N,
                className: "border bg-black text-white rounded-sm px-4 py-2",
                children: "Search",
              }),
            ],
          }),
          P.jsx("div", {
            className:
              "flex justify-center items-center gap-10 flex-wrap w-[90%] mx-auto",
            children: E(nl === null ? $ : nl),
          }),
        ],
      }),
      P.jsx(G1, {}),
...
function Q1() {
  return P.jsx(P.Fragment, { children: P.jsx(j1, {}) });
}
x1.createRoot(document.getElementById("root")).render(
  P.jsx(ga.StrictMode, { children: P.jsx(Q1, {}) })
);
